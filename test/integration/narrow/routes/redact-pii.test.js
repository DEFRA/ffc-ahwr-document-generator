...
const mockAgreementsToRedact = [{ reference: 'FAKE-REF-1', sbi: 'FAKE-SBI-1', redactedSbi: '103534943' }]
...
describe('redact-pii', () => {
  ...
  describe('POST /api/redact/pii', () => {
    test('should return OK status when called with agreementsToRedact in payload', async () => {
      ...
      expect(redactPII).toHaveBeenCalledWith('FAKE-REF-1', '103534943', expect.any(Object))
